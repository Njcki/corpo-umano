#!/usr/bin/env python3
"""Screenshot Femmina with adaptive envelope (involucro) via existing box Chrome CDP (9224)."""
import base64, json, os, socket, struct, time, urllib.request
from urllib.parse import urlparse

PORT = 9224
URL = "http://127.0.0.1:5173/?t=involucrov1"
OUT = "/workspace/corpo-umano/screenshots/donna-involucro.png"
